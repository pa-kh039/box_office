...
const CustomRadio = ({ label, ...restProps }) => {
  return (
    <RadioWrapper htmlFor={restProps.id}>
      ...
      {/* if we write it like above, type="radio" is replaced with the vaue of type from  */}
      {/* but with below syntax value of type received from ....restProps is replaced with the value "radio" */}
